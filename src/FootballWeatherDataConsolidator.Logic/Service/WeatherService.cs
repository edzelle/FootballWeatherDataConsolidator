...
namespace FootballWeatherDataConsolidator.Logic.Service
{
    public class WeatherService : IWeatherService
    {
        ...
        private const string hourlyMetrics = "temperature_2m,relative_humidity_2m,apparent_temperature,rain,snowfall,wind_speed_10m";
        ...
        private async Task LoadGameData(GameEntity game)
        {
            ...
            if (venue != null)
            {
                ...
                var weatherGameEntity = new GameWeatherEntity()
                {
                    ...
                    AverageRelativeHumitidty = weatherDataForGame.AverageRelativeHumitidty,
                    AverageSnowfall = weatherDataForGame.AverageSnowfall,
                    AverageTempurature = weatherDataForGame.AverageTempurature,
                    AverageWindSpeed = weatherDataForGame.AverageWindSpeed
                };
